export const chapters: Array<{name: string; route: string; descp: string}> = [
  ...
  { name: 'Women@CodeIIEST', route: '/chapters/women-codeiiest', descp: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio eligendi similique exercitationem optio libero vitae accusamus cupiditate laborum eos.' },
]
