            ...
            <div class="space-y-6">
              ...
              <div class="space-y-2">
                <div class="text-lg leading-6 font-medium space-y-1">
                  ...
                  <p class="text-red-600">Copywriter</p>
                </div>
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-2">
                <div class="text-lg leading-6 font-medium space-y-1">
                  ...
                  <p class="text-red-600">Senior Designer</p>
                </div>
                <ul class="flex justify-center space-x-5">
                  <li>
                    <a href="#" class="text-gray-400 hover:text-gray-500">
          ...
          <li>
            <div class="space-y-6">
              ...
              <div class="space-y-2">
                <div class="text-lg leading-6 font-medium space-y-1">
                  <h3>Floyd Miles</h3>
                  <p class="text-red-600">Principal Designer</p>
                </div>
                <ul class="flex justify-center space-x-5">
                  <li>
                    <a href="#" class="text-gray-400 hover:text-gray-500">
          ...
          <li>
            <div class="space-y-6">
              ...
              <div class="space-y-2">
                <div class="text-lg leading-6 font-medium space-y-1">
                  <h3>Emily Selman</h3>
                  <p class="text-red-600">VP, User Experience</p>
                </div>
                <ul class="flex justify-center space-x-5">
                  <li>
                    <a href="#" class="text-gray-400 hover:text-gray-500">
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-2">
                <div class="text-lg leading-6 font-medium space-y-1">
                  ...
                  <p class="text-red-600">VP, Human Resources</p>
                </div>
                <ul class="flex justify-center space-x-5">
                  <li>
                    <a href="#" class="text-gray-400 hover:text-gray-500">
          ...
          <li>
            <div class="space-y-6">
              ...
              <div class="space-y-2">
                <div class="text-lg leading-6 font-medium space-y-1">
                  <h3>Emma Dorsey</h3>
                  <p class="text-red-600">Senior Front-end Developer</p>
                </div>
                <ul class="flex justify-center space-x-5">
                  <li>
                    <a href="#" class="text-gray-400 hover:text-gray-500">
