<template>
  <div class="text-center">
    <h1 class="dark:text-gray-100 text-gray-900 text-4xl tracking-tight font-extrabold  sm:text-5xl md:text-6xl">
    ...
    <div class="mt-15">
      ...
      <div class="flex flex-wrap justify-center mt-5">
        <div v-for="(chapter, index) in chapters" :key="index" class="w-full max-w-sm px-4 py-3 mx-5 my-3 bg-white rounded-md shadow-md hover:shadow-lg dark:bg-dark-800">
          <div>
